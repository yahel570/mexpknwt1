function getTarget() {
    ...
    var T2Filler1Rating = [ '-3: Dislike a lot', '-2: Moderately dislike', '-1: Slightly dislike','0: Neutral', '1: Slightly like', '2: Moderately like', '3: Like a lot'];
    var T2Filler2Rating = [ '-1: Slightly dislike','0: Neutral', '1: Slightly like', '2: Moderately like', '3: Like a lot','-3: Dislike a lot', '-2: Moderately dislike'];
    var T2Filler3Rating = [ '-3: Dislike a lot','0: Neutral', '1: Slightly like', '2: Moderately like', '-2: Moderately dislike', '-1: Slightly dislike','3: Like a lot'];
    var T2Filler4Rating = [  '1: Slightly like', '-3: Dislike a lot', '-1: Slightly dislike','0: Neutral','2: Moderately like', '-2: Moderately dislike', '3: Like a lot'];
    var T2Target1Rating = [ '1: Slightly like', '2: Moderately like', '-3: Dislike a lot', '-2: Moderately dislike','0: Neutral', '3: Like a lot', '-1: Slightly dislike'];
    var T2Target2Rating = [ '0: Neutral', '1: Slightly like', '2: Moderately like', '-3: Dislike a lot', '-2: Moderately dislike', '-1: Slightly dislike','3: Like a lot'];
    var T2Target3Rating = [ '-3: Dislike a lot','1: Slightly like', '-2: Moderately dislike', '2: Moderately like', '-1: Slightly dislike','0: Neutral', '3: Like a lot'];
    var T2Target4Rating = [ '1: Slightly like', '2: Moderately like', '3: Like a lot', '-3: Dislike a lot', '-2: Moderately dislike', '-1: Slightly dislike','0: Neutral'];
